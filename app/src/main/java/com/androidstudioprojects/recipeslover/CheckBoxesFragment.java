...
public abstract class CheckBoxesFragment extends Fragment {
	private static final String KEY_CHECKBOXES = "key_checked_boxes";
	...
	public View onCreateView(@NonNull LayoutInflater inflater,
		...
		View view = inflater.inflate(R.layout.fragment_checkboxes, container,
						false);
		...
		if (savedInstanceState != null &&
						savedInstanceState.getBooleanArray(KEY_CHECKBOXES) != null) {
	...
	private void setUpCheckBoxes(String[] contents, ViewGroup container,
	                             boolean[] checkBoxes) {
		int i = 0;
